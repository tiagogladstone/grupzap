-- ============================================================================
-- MIGRATION 003: Schema Consolidado
-- ============================================================================
-- Esta migration consolida o schema completo do Grupzap.
-- E baseada no schema.sql (source of truth).
--
-- NOTA: Se voce esta rodando em um banco NOVO, execute apenas esta migration.
-- Se ja rodou 001 e 002, execute esta migration que ira:
--   1. Dropar tabelas da migration 001 se existirem (profiles, organization_members)
--   2. Criar/atualizar todas as tabelas do schema atual
--   3. Manter a migration 002 (pg_cron) intacta
--
-- Migration 001 (001_auth_schema.sql) esta DEPRECATED.
-- Migration 002 (002_pg_cron_scheduled_messages.sql) continua valida.
-- ============================================================================

-- ============================================================================
-- PASSO 0: DROPAR TABELAS ANTIGAS DA MIGRATION 001 (se existirem)
-- ============================================================================
-- A migration 001 criava profiles e organization_members que nao fazem mais
-- parte do schema atual. O modelo agora usa a tabela users com organization_id
-- direto (sem tabela de juncao).

-- Dropar trigger antigo que criava profile no signup
DROP TRIGGER IF EXISTS on_auth_user_created ON auth.users;

-- Dropar funcao antiga do signup
DROP FUNCTION IF EXISTS public.handle_new_user();

-- Dropar policies antigas das tabelas deprecated
...
-- Dropar tabelas deprecated
DROP TABLE IF EXISTS public.organization_members CASCADE;
DROP TABLE IF EXISTS public.profiles CASCADE;

-- ============================================================================
-- PASSO 1: EXTENSOES E FUNCOES AUXILIARES
-- ============================================================================
...
-- Funcao auxiliar para verificar se usuario pertence a uma organizacao
...
-- Funcao auxiliar para obter organization_id do usuario atual
...
-- Funcao para verificar se usuario e admin da organizacao
...
-- ============================================================================
-- PASSO 2: TABELAS PRINCIPAIS
-- ============================================================================

-- ----------------------------------------------------------------------------
-- ORGANIZATIONS (Multi-tenant)
-- ----------------------------------------------------------------------------
-- Cada organizacao representa um cliente/empresa usando o Grupzap
...
-- ----------------------------------------------------------------------------
-- Usuarios do sistema, vinculados a uma organizacao
...
-- ----------------------------------------------------------------------------
-- WHATSAPP_INSTANCES (Conexoes UAZAPI)
-- ----------------------------------------------------------------------------
-- Instancias do WhatsApp conectadas via UAZAPI
CREATE TABLE IF NOT EXISTS public.whatsapp_instances (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    organization_id UUID NOT NULL REFERENCES public.organizations(id) ON DELETE CASCADE,
    instance_name TEXT NOT NULL,
    instance_id TEXT UNIQUE NOT NULL, -- ID retornado pela UAZAPI
    api_token TEXT, -- Token de API da instancia (criptografado em producao)
    phone_number TEXT,
...
CREATE TABLE IF NOT EXISTS public.group_members (
    ...
    organization_id UUID NOT NULL REFERENCES public.organizations(id) ON DELETE CASCADE,
    phone_jid TEXT NOT NULL, -- ID do usuario no WhatsApp (ex: 5511999999999@s.whatsapp.net)
    phone_number TEXT, -- Numero formatado
    name TEXT,
    push_name TEXT, -- Nome definido pelo proprio usuario
...
CREATE TABLE IF NOT EXISTS public.scheduled_messages (
    ...
    media_filename TEXT,
    buttons JSONB, -- Botoes interativos
...
-- Indices para scheduled_messages
...
-- MESSAGE_LOGS
-- ----------------------------------------------------------------------------
-- Log de mensagens para analytics (SEM conteudo sensivel por privacidade)
...
-- ----------------------------------------------------------------------------
-- Assinaturas e informacoes de cobranca
CREATE TABLE IF NOT EXISTS public.subscriptions (
    ...
    quantity INT DEFAULT 1, -- Numero de "seats" ou instancias
    metadata JSONB DEFAULT '{}',
    created_at TIMESTAMPTZ DEFAULT NOW() NOT NULL,
    updated_at TIMESTAMPTZ DEFAULT NOW() NOT NULL,
...
-- ============================================================================
-- PASSO 3: TABELAS AUXILIARES
-- ============================================================================

-- ----------------------------------------------------------------------------
-- HEALTH_CHECKS (Historico de verificacoes)
-- ----------------------------------------------------------------------------
...
-- WhatsApp Instances
DROP TRIGGER IF EXISTS trigger_instances_updated_at ON public.whatsapp_instances;
...
-- WhatsApp Groups
DROP TRIGGER IF EXISTS trigger_groups_updated_at ON public.whatsapp_groups;
...
-- Group Members
DROP TRIGGER IF EXISTS trigger_members_updated_at ON public.group_members;
...
-- Scheduled Messages
DROP TRIGGER IF EXISTS trigger_scheduled_updated_at ON public.scheduled_messages;
...
-- ============================================================================
-- PASSO 5: ROW LEVEL SECURITY (RLS) POLICIES
-- ============================================================================
...
-- DROP policies existentes para evitar conflito
DROP POLICY IF EXISTS "organizations_select_own" ON public.organizations;
DROP POLICY IF EXISTS "organizations_update_admin" ON public.organizations;
DROP POLICY IF EXISTS "organizations_insert_service" ON public.organizations;
DROP POLICY IF EXISTS "organizations_delete_never" ON public.organizations;

-- SELECT: Usuarios podem ver sua propria organizacao
...
-- SELECT: Usuarios podem ver membros da mesma organizacao
...
-- UPDATE: Usuarios podem atualizar proprio perfil, admins podem atualizar outros
...
DROP POLICY IF EXISTS "instances_select_org" ON public.whatsapp_instances;
DROP POLICY IF EXISTS "instances_insert_admin" ON public.whatsapp_instances;
DROP POLICY IF EXISTS "instances_update_admin" ON public.whatsapp_instances;
DROP POLICY IF EXISTS "instances_delete_admin" ON public.whatsapp_instances;

-- SELECT: Usuarios podem ver instancias da sua organizacao
...
-- INSERT: Admins podem criar instancias
...
DROP POLICY IF EXISTS "groups_select_org" ON public.whatsapp_groups;
DROP POLICY IF EXISTS "groups_insert_member" ON public.whatsapp_groups;
DROP POLICY IF EXISTS "groups_update_member" ON public.whatsapp_groups;
DROP POLICY IF EXISTS "groups_delete_admin" ON public.whatsapp_groups;

-- SELECT: Usuarios podem ver grupos da sua organizacao
...
DROP POLICY IF EXISTS "members_select_org" ON public.group_members;
DROP POLICY IF EXISTS "members_insert_member" ON public.group_members;
DROP POLICY IF EXISTS "members_update_member" ON public.group_members;
DROP POLICY IF EXISTS "members_delete_member" ON public.group_members;

-- SELECT: Usuarios podem ver membros dos grupos da sua organizacao
...
DROP POLICY IF EXISTS "scheduled_select_org" ON public.scheduled_messages;
DROP POLICY IF EXISTS "scheduled_insert_member" ON public.scheduled_messages;
...
-- SELECT: Usuarios podem ver mensagens agendadas da sua organizacao
...
-- UPDATE: Membros podem atualizar (proprias ou admins todas)
...
DROP POLICY IF EXISTS "messages_select_org" ON public.message_logs;
DROP POLICY IF EXISTS "messages_insert_service" ON public.message_logs;
DROP POLICY IF EXISTS "messages_update_never" ON public.message_logs;
DROP POLICY IF EXISTS "messages_delete_never" ON public.message_logs;

-- SELECT: Usuarios podem ver logs da sua organizacao
...
-- UPDATE/DELETE: Nunca (logs sao imutaveis)
...
-- SELECT: Usuarios podem ver subscription da sua organizacao
...
DROP POLICY IF EXISTS "health_select_org" ON public.health_checks;
DROP POLICY IF EXISTS "health_insert_service" ON public.health_checks;
DROP POLICY IF EXISTS "health_update_never" ON public.health_checks;
DROP POLICY IF EXISTS "health_delete_never" ON public.health_checks;

-- SELECT: Usuarios podem ver health checks da sua organizacao
...
DROP POLICY IF EXISTS "webhook_select_admin" ON public.webhook_events;
DROP POLICY IF EXISTS "webhook_insert_service" ON public.webhook_events;
DROP POLICY IF EXISTS "webhook_update_service" ON public.webhook_events;
DROP POLICY IF EXISTS "webhook_delete_service" ON public.webhook_events;

-- SELECT: Admins podem ver eventos da sua organizacao
...
DROP POLICY IF EXISTS "audit_update_never" ON public.audit_logs;
DROP POLICY IF EXISTS "audit_delete_never" ON public.audit_logs;

-- SELECT: Admins podem ver audit logs da sua organizacao
...
-- UPDATE/DELETE: Nunca (audit logs sao imutaveis)
...
-- ============================================================================
-- PASSO 6: FUNCOES DE NEGOCIO
-- ============================================================================

-- Funcao para criar uma nova organizacao com usuario owner
...
BEGIN
    ...
    -- Criar/atualizar usuario como owner
...
-- Funcao para obter estatisticas de um grupo
...
-- Funcao para atualizar health score de um grupo
...
BEGIN
    ...
    -- Contar mensagens da ultima semana
...
-- ============================================================================
-- PASSO 7: REALTIME (Habilitar para tabelas especificas)
-- ============================================================================

-- Nota: Execute estes comandos separadamente se a publication ja existir
...
-- ============================================================================
-- PASSO 8: COMENTARIOS NAS TABELAS (Documentacao)
-- ============================================================================

COMMENT ON TABLE public.organizations IS 'Organizacoes/tenants do sistema multi-tenant';
COMMENT ON TABLE public.users IS 'Usuarios do sistema, vinculados a uma organizacao';
COMMENT ON TABLE public.whatsapp_instances IS 'Instancias WhatsApp conectadas via UAZAPI';
...
COMMENT ON TABLE public.message_logs IS 'Log de mensagens para analytics (sem conteudo sensivel)';
COMMENT ON TABLE public.subscriptions IS 'Assinaturas e informacoes de billing';
COMMENT ON TABLE public.health_checks IS 'Historico de verificacoes de saude das instancias';
COMMENT ON TABLE public.webhook_events IS 'Fila de webhooks recebidos para processamento';
COMMENT ON TABLE public.audit_logs IS 'Logs de auditoria de acoes no sistema';
