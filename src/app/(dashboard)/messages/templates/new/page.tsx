...
export default function NewTemplatePage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (!res.ok) {
        setError(json.error?.message || 'Erro ao criar template')
        return
      }
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div>
        ...
        <h1 className="text-2xl font-bold text-[var(--foreground)]">Novo Template</h1>
        <p className="text-[var(--muted)] mt-1">
          Crie um template reutilizavel para suas mensagens.
        </p>
      </div>
